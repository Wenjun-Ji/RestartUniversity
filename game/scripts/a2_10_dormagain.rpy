label a_dormagain:
    ...
    $ res = select_ai.invoke("我回到了宿舍", value_dict, plot_history, ["dorm_party", "dorm_quarrel","dorm_clean"])
    if res == "dorm_party":
...
label a_party_join:
    ...
    python:
        ...
        li = value_ai.invoke(new_plot, "E:-20~-15,A:-10~-5,B:-15~-10,M:+15~+20,S:+15~+20,F:-5~-3", value_dict)
...
label a_party_sleep:
    ...
    python:
        ...
        li = value_ai.invoke(new_plot, "E:+10~+15,A:+5~+10,B:+10~+15,M:-5~-3,S:-10~-5,F:0~0", value_dict)
...
label a_party_moderate:
    ...
    python:
        ...
        li = value_ai.invoke(new_plot, "E:-5~-3,A:0~0,B:-3~-1,M:+5~+10,S:+10~+15,F:-3~-1", value_dict)
...
label a_quarrel_communicate:
    ...
    python:
        ...
        li = value_ai.invoke(new_plot, "E:-10~-5,A:0~0,B:0~0,M:+10~+15,S:+15~+20,F:0~0", value_dict)
...
label a_quarrel_endure:
    ...
    python:
        ...
        li = value_ai.invoke(new_plot, "E:-5~-3,A:-5~-3,B:-5~-3,M:-15~-10,S:-10~-5,F:0~0", value_dict)
...
label a_quarrel_report:
    ...
    python:
        ...
        li = value_ai.invoke(new_plot, "E:-15~-10,A:0~0,B:-5~-3,M:-10~-5,S:-20~-15,F:0~0", value_dict)
...
label a_clean_thoroughly:
    ...
    python:
        ...
        li = value_ai.invoke(new_plot, "E:-15~-10,A:0~0,B:+10~+15,M:+10~+15,S:+5~+10,F:-3~-1", value_dict)
...
label a_clean_barely:
    ...
    python:
        ...
        li = value_ai.invoke(new_plot, "E:-5~-3,A:0~0,B:-5~-3,M:-5~-3,S:-3~-1,F:0~0", value_dict)
...
label a_clean_ignore:
    ...
    python:
        ...
        li = value_ai.invoke(new_plot, "E:0~0,A:0~0,B:-15~-10,M:-10~-5,S:-15~-10,F:0~0", value_dict)
