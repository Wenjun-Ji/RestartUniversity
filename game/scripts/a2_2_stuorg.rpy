...
label a_joinstuorg:
    scene bg university  # 这个是学生活动中心的背景
    ...
    python:
        ...
        # 调用AI更新属性
        li = value_ai.invoke(new_plot, "E:-5~-3,A:-3~0,B:+3~+5,M:+10~+20,S:+5~+10,F:-3~0", value_dict)
...
label a_notjoinstuorg:
    scene bg library  # 这个是家中客厅的背景，你可以根据实际场景设置
    ...
    python:
        ...
        # 调用AI更新属性
        li = value_ai.invoke(new_plot, "E:+1~+5,A:0~+2,B:0~0,M:+3~+5,S:0~0,F:0~0", value_dict)
