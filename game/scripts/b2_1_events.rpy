    ...
    menu:
        "接受休息，暂时放下学业和社交":
            python:
                ...
                li = value_ai.invoke(new_plot, "E:+30~+50,A:-10~-5,B:+20~+30,M:+10~+20,S:-10~-5,F:0~0", value_dict)
        ...
        "继续保持作息，拒绝医生建议":
            python:
                ...
                li = value_ai.invoke(new_plot, "E:-30~-20,A:-20~-10,B:-30~-20,M:-20~-10,S:-5~-3,F:0~0", value_dict)
                #renpy.say(None, "\n".join([f"{key}：{value}" for key, value in li.items()]))
    ...
    menu:
        "主动联系朋友，重建关系":
            python:
                ...
                li = value_ai.invoke(new_plot, "E:-5~-3,A:-5~-3,B:0~0,M:+20~+30,S:+30~+50,F:-5~-3", value_dict)
                #renpy.say(None, "\n".join([f"{key}：{value}" for key, value in li.items()]))
        ...
        "继续专注个人事务，忽略孤独感":
            python:
                ...
                li = value_ai.invoke(new_plot, "E:0~0,A:+10~+20,B:-5~-3,M:-20~-10,S:-30~-20,F:0~0", value_dict)
                #renpy.say(None, "\n".join([f"{key}：{value}" for key, value in li.items()]))
    ...
    menu:
        "请求同学帮助，进行补习":
            python:
                ...
                li = value_ai.invoke(new_plot, "E:-10~-5,A:+30~+50,B:0~0,M:+10~+20,S:+10~+20,F:-5~-3", value_dict)
                #renpy.say(None, "\n".join([f"{key}：{value}" for key, value in li.items()]))
        ...
        "独自面对困难，试图自我解决":
            python:
                ...
                li = value_ai.invoke(new_plot, "E:-20~-10,A:+10~+20,B:-5~-3,M:-20~-10,S:-5~-3,F:0~0", value_dict)
                #renpy.say(None, "\n".join([f"{key}：{value}" for key, value in li.items()]))
        ...
        "放任不管，选择躺平":
            ...
            python:
                li = value_ai.invoke(new_plot, "E:+10~+20,A:-50~-30,B:0~0,M:-30~-20,S:-10~-5,F:0~0", value_dict)
                #renpy.say(None, "\n".join([f"{key}：{value}" for key, value in li.items()]))
    ...
    menu:
        "寻求心理咨询，缓解压力":
            python:
                ...
                li = value_ai.invoke(new_plot, "E:-5~-3,A:0~0,B:+10~+20,M:+30~+50,S:+5~+10,F:-20~-10", value_dict)
                #renpy.say(None, "\n".join([f"{key}：{value}" for key, value in li.items()]))
        ...
        "忽视情绪，继续前进":
            python:
                ...
                li = value_ai.invoke(new_plot, "E:-20~-10,A:-10~-5,B:-20~-10,M:-30~-20,S:-10~-5,F:0~0", value_dict)
                #renpy.say(None, "\n".join([f"{key}：{value}" for key, value in li.items()]))
        ...
        "与朋友倾诉，寻求支持":
            python:
                ...
                li = value_ai.invoke(new_plot, "E:0~0,A:-5~-3,B:+5~+10,M:+20~+30,S:+20~+30,F:0~0", value_dict)
                #renpy.say(None, "\n".join([f"{key}：{value}" for key, value in li.items()]))
    ...
    menu:
        "寻找兼职工作，自己解决问题":
            ...
            python:
                ...
                li = value_ai.invoke(new_plot, "E:-20~-10,A:-10~-5,B:-5~-3,M:+10~+20,S:-5~-3,F:+30~+50", value_dict)
                #renpy.say(None, "\n".join([f"{key}：{value}" for key, value in li.items()]))
        ...
        "向家人或朋友借钱":
            python:
                ...
                li = value_ai.invoke(new_plot, "E:0~0,A:0~0,B:0~0,M:-10~-5,S:-20~-10,F:+20~+30", value_dict)
                #renpy.say(None, "\n".join([f"{key}：{value}" for key, value in li.items()]))
        ...
        "申请学生贷款":
            python:
                ...
                li = value_ai.invoke(new_plot, "E:0~0,A:0~0,B:0~0,M:-20~-10,S:0~0,F:+10~+20", value_dict)
                #renpy.say(None, "\n".join([f"{key}：{value}" for key, value in li.items()]))
...
label event_high_social:
    ...
    menu:
        "减少社交活动，给自己留些时间":
            ...
            python:
                li = value_ai.invoke(new_plot, "E:+20~+30,A:+10~+20,B:+10~+20,M:+20~+30,S:-20~-10,F:+5~+10", value_dict)
                #renpy.say(None, "\n".join([f"{key}：{value}" for key, value in li.items()]))
        ...
        "继续维持高社交频率，忽略疲惫感":
            ...
            python:
                li = value_ai.invoke(new_plot, "E:-30~-20,A:-20~-10,B:-20~-10,M:-30~-20,S:+10~+20,F:-10~-5", value_dict)
                #renpy.say(None, "\n".join([f"{key}：{value}" for key, value in li.items()]))
...
label b_event_low_health:
    ...
    menu:
        "听从医生建议，认真调整作息和饮食":
            python:
                plot_history.extend(["旁白：我选择听从���生建议，认真调整作息和饮食"])
                li = value_ai.invoke(new_plot, "E:-10~-5,A:-5~-3,B:+30~+50,M:+10~+20,S:-5~-3,F:-10~-5", value_dict)
                #renpy.say(None, "\n".join([f"{key}：{value}" for key, value in li.items()]))
        ...
        "觉得小题大做，并没有接受医生的建议":
            python:
                ...
                li = value_ai.invoke(new_plot, "E:-5~-3,A:0~0,B:-20~-10,M:-10~-5,S:0~0,F:-5~-3", value_dict)
                #renpy.say(None, "\n".join([f"{key}：{value}" for key, value in li.items()]))
