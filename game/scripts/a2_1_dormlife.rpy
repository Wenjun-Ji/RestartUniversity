...
label a_satisfiedlife:
    ...
    python:
        ...
        # 调用AI更新属性
        li = value_ai.invoke(new_plot, "E:+1~+5,A:0~0,B:+3~+5,M:+10~+20,S:+5~+10,F:-5~-3", value_dict)
...
label a_dissatisfiedlife:
    ...
    python:
        ...
        # 调用AI更新属性
        li = value_ai.invoke(new_plot, "E:-5~-1,A:-5~-3,B:-5~-3,M:-20~-10,S:-10~-5,F:-5~-3", value_dict)
