...
label a_study_library:
    ...
    python:
        ...
        # 调用AI生成新的场景剧情
        new_plot = text_ai.invoke(scen_desc_2, plot_history, value_dict)
        ...
        li = value_ai.invoke(new_plot, "E:-20~-15,A:+15~+20,B:-10~-5,M:+5~+10,S:+3~+5,F:-5~-3", value_dict)
...
label a_study_dorm:
    ...
    python:
        ...
        # 调用AI生成新的场景剧情
        new_plot = text_ai.invoke(scen_desc_3, plot_history, value_dict)
        ...
        li = value_ai.invoke(new_plot, "E:-10~-5,A:+10~+15,B:-3~-1,M:+3~+5,S:0~0,F:0~0", value_dict)
...
label a_study_class:
    ...
    python:
        ...
        # 调用AI生成新的场景剧情
        new_plot = text_ai.invoke(scen_desc_4, plot_history, value_dict)
        ...
        li = value_ai.invoke(new_plot, "E:-15~-10,A:+20~+25,B:-5~-3,M:+10~+15,S:+10~+15,F:-10~-5", value_dict)
...
label a_study_classroom:
    ...
    python:
        ...
        # 调用AI生成新的场景剧情
        new_plot = text_ai.invoke(scen_desc_5, plot_history, value_dict)
        ...
        li = value_ai.invoke(new_plot, "E:-12~-8,A:+12~+18,B:-3~-1,M:+8~+12,S:0~0,F:-2~-1", value_dict)
...
label a_study_cafe:
    ...
    python:
        ...
        # 调用AI生成新的场景剧情
        new_plot = text_ai.invoke(scen_desc_6, plot_history, value_dict)
        ...
        li = value_ai.invoke(new_plot, "E:-8~-5,A:+8~+12,B:-5~-3,M:+10~+15,S:+3~+5,F:-15~-10", value_dict)
