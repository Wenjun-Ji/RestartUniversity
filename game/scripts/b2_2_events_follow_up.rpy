...
label event_low_study_self:
    scene bg dormitory_night  # 宿舍夜晚背景
...
label event_low_mental_counsel:
    scene bg counseling_room  # 咨询室背景
...
label event_low_finance_loan:
    scene bg counselor_office  # 辅导员办公室背景
