...
label a_PEclass:
    ...
    $ res = select_ai.invoke("我在上体育课", value_dict, plot_history, ["normal_class", "PE_test","tired"])
    if res == "normal_class":
...
label a_normal_class:
    ...
    python:
        ...
        # 调用AI更新属性
        li = value_ai.invoke(new_plot, "E:+5~+10,A:+3~+5,B:+10~+20,M:+5~+10,S:+5~+10,F:0~0", value_dict)
...
label a_takeitseriously:
    ...
    python:
        ...
        # 调用AI更新属性
        li = value_ai.invoke(new_plot, "E:-5~-3,A:+3~+5,B:+10~+20,M:+5~+10,S:+5~+10,F:0~0", value_dict)
...
label a_notseriously:
    ...
    python:
        ...
        # 调用AI更新属性
        li = value_ai.invoke(new_plot, "E:0~0,A:-5~-3,B:-10~-5,M:-10~-5,S:-5~-3,F:0~0", value_dict)
...
label a_persistPE:
    ...
    python:
        ...
        # 调用AI更新属性
        li = value_ai.invoke(new_plot, "E:-10~-5,A:-3~0,B:-5~-3,M:+3~+5,S:+3~+5,F:0~0", value_dict)
...
label a_leavePE:
    ...
    python:
        ...
        # 调用AI更新属性
        li = value_ai.invoke(new_plot, "E:-10~-5,A:-3~0,B:-5~-3,M:-5~-3,S:-5~-3,F:0~0", value_dict)
...
label a_playPE:
    ...
    python:
        ...
        # 调用AI更新属性
        li = value_ai.invoke(new_plot, "E:-10~-5,A:-20~-10,B:-10~-5,M:-20~-10,S:-20~-10,F:-10~-5", value_dict)
