label a_takeclass:
    ...
    $ res = select_ai.invoke("我即将开始上课", value_dict, plot_history, ["important_class", "group_discussion"])
...
label a_class_focus:
    ...
    python:
        ...
        li = value_ai.invoke(new_plot, "E:-15~-10,A:+15~+20,B:-5~-3,M:-5~-3,S:0~0,F:0~0", value_dict)
...
label a_class_distracted:
    python:
        ...
        li = value_ai.invoke(new_plot, "E:-5~-3,A:-10~-5,B:-3~-1,M:+5~+10,S:+3~+5,F:0~0", value_dict)
...
label a_discussion_active:
    ...
    python:
        ...
        li = value_ai.invoke(new_plot, "E:-10~-5,A:+10~+15,B:0~0,M:+5~+10,S:+15~+20,F:0~0", value_dict)
...
label a_discussion_passive:
    ...
    python:
        ...
        li = value_ai.invoke(new_plot, "E:-3~-1,A:+5~+8,B:0~0,M:-3~-1,S:-5~-3,F:0~0", value_dict)
