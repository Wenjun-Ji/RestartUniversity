...
screen start_loading_screen():
    # 显示黑色背景
    frame:
        background Solid("#00000060")  # 黑色背景
        xfill True
        yfill True

        vbox:
            align (0.5, 0.5)  # 将文字居中显示
            text "正在为您重开大学生活中...":
                color "#FFF"  # 白色文字
                size 40  # 设置字体大小
                bold True  # 加粗文字

screen text_loading_screen():
    # 显示黑色背景
    frame:
        background Solid("#00000060")  # 黑色背景
        xfill True
